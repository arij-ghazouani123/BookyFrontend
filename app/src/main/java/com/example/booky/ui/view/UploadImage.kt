    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_date!!.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                DatePickerDialog(this@UploadImage,
                    dateSetListener,
            ...
            if (description != null) {
                if (subject != null) {
                    ...
                    if (selectedRadioButtonId != -1) {
                        ...
                        Toast.makeText(this@UploadImage, "Nothing selected from the radio group", Toast.LENGTH_SHORT).show()
...
//put something inside the map, could be null
        ...
        apiInterface.createbook(body).enqueue(object : Callback<Book> {
            ...
            override fun onResponse(call: Call<Book>, response: Response<Book>) {
                ...
                if (user != null){
                    Toast.makeText(this@UploadImage, "Book Aded", Toast.LENGTH_SHORT).show()
                    doUpdateImage(user.id)


                }else{
                    Toast.makeText(this@UploadImage, "can not Add Book", Toast.LENGTH_SHORT).show()
                }
